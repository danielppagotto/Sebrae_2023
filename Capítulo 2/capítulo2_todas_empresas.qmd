...
writexl::write_xlsx(base_completa1, "fre_masc_fem_todas_empresas.xlsx")
...
taxa_pop_sexo_ano <- 
    ...
    mutate(cod_IBGE = as.numeric(cod_IBGE)) |> 
    mutate(ano = as.numeric(ano)) |> 
    mutate(genero = recode(genero, "Female" = "Feminino", "Male" = "Masculino")) |>
    left_join(pop_total, by = c("ano"="ANO","cod_IBGE"="COD_MUN", "genero" = "SEXO")) |>
    mutate(taxa = (total/POPULACAO) * 100)
   


writexl::write_xlsx(taxa_pop_sexo_ano, "taxa_pop_sexo_ano_todas_empresas.xlsx")
